  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Button, { time: '1500', startTimer: this.startTimer })
      ),
      ...
      this.state.timeLeft > 0 && React.createElement(
        ...
        React.createElement(
          ...
          this.state.timer === null ? React.createElement(
            'button',
            { className: 'btn btn-success', onClick: this.resumeTimer },
            'Resume'
          ) : React.createElement(
            'button',
            { className: 'btn btn-warning', onClick: this.stopTimer },
            'Pause'
          ),
          React.createElement(
            'button',
            { className: 'btn btn-danger', onClick: this.cancelTimer },
            'Cancel'
          ),
          React.createElement(
            'button',
            { className: 'btn btn-primary', onClick: this.resetTimer },
            'Reset'
          )
        )
      ),
